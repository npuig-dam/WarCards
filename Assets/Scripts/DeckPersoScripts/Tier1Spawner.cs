...
public class Tier1Spawner : MonoBehaviour
{
    [SerializeField]
    ...
    public List<Cards> CardPrefabs = new();
    ...
    {
        for (int i = 0; i < allTiers.TierIPrefabs.Count; i++)
        {
            ShowCard(i);
    ...
    public GameObject DrawCard(int num)
    {
        ...
        GameObject prefab = allTiers.TierIPrefabs[num];
